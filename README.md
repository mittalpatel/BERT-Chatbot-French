...
## Instructions to set up the Bert French Demo on Local system

1. Clone the repository in your system.
2. Download the model file from https://drive.google.com/file/d/1ExZP7tOlrA7yeFMGyOpJ2vB9CvQ9JIM7/view?usp=sharing and unzip it in root directory.
